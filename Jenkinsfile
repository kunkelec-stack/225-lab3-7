pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/kunkelec'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/kunkelec-stack/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('kunkelec-225-sp26')                                                         //<------your MiamiID
    }
